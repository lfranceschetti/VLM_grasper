...
import pybullet
from VLM_grasper.simulator.grasp import Label
from VLM_grasper.simulator.perception import *
import VLM_grasper.simulator.btsim as btsim
from VLM_grasper.simulator.workspace_lines import workspace_lines
...
class ClutterRemovalSim(object):
    def __init__(self, scene, object_set, gui=True, seed=None,rand=False):
        ...
        self.urdf_root = Path("/home/lucfra/semester-project/catkin_ws/src/VLM_grasper/src/VLM_grasper/data_robot/urdfs")
        self.obj_root = Path('/home/lucfra/semester-project/catkin_ws/src/VLM_grasper/src/VLM_grasper/data_robot/graspnet_1B_object_test/GraspNet1B_object')
        self.egad_root = Path(Path('/home/lucfra/semester-project/catkin_ws/src/VLM_grasper/src/VLM_grasper/data_robot/egad_eval_set'))
        self.scene = scene
