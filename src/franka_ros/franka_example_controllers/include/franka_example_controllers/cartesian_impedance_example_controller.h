...
class CartesianImpedanceExampleController : public controller_interface::MultiInterfaceController<
 ...
 public:
  ...
  void starting(bool resetNullspaceConfiguration);
 ...
 private:
  ...
  Eigen::Matrix<double, 6, 6> cartesian_stiffness_i_;
  Eigen::Matrix<double, 6, 6> cartesian_stiffness_target_i_;
  Eigen::Matrix<double, 6, 1> windup_limit_;
  Eigen::Matrix<double, 6, 1> windup_limit_target_;
  double forceLimit_, forceLimitTarget_, torqueLimit_, torqueLimitTarget_;
  ...
  Eigen::Matrix<double, 6, 1> errorIntegrator_;
