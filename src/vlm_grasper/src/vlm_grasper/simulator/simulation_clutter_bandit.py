...
class ClutterRemovalSim(object):
    def __init__(self, scene, object_set, gui=True, seed=None,rand=False):
        ...
        self.urdf_root = Path("/home/lucfra/catkin_ws/src/vlm_grasper/src/vlm_grasper/data_robot/urdfs")
        self.obj_root = Path('/home/lucfra/catkin_ws/src/vlm_grasper/src/vlm_grasper/data_robot/graspnet_1B_object_test/GraspNet1B_object')
        self.egad_root = Path(Path('/home/lucfra/catkin_ws/src/vlm_grasper/src/vlm_grasper/data_robot/egad_eval_set'))
        self.scene = scene
